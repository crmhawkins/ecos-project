        ...
        <div class="table-responsive">
            ...
            @if( count($categorias) == 0 )
                <div class="text-center py-4">
                    <h3 class="text-center fs-3">No se encontraron registros de <strong>CATEGORIA DE PRODUCTOS</strong></h3>
                </div>
            @endif
...
@section('scripts')
    ...
    <script>
        ...
        function botonAceptar(id){
            ...
            Swal.fire({
                title: "¿Estas seguro que quieres eliminar esta categoria de producto?",
        ...
        function getDelete(id) {
            // Ruta de la peticion
            const url = '{{route("productosCategoria.delete")}}'
            // Peticion
            return $.ajax({
                type: "POST",
                url: url,
