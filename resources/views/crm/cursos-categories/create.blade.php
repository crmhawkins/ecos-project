...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('cursosCategoria.store') }}">
        @csrf
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control" 
                              placeholder="Descripción detallada de la categoría">{{ old('descripcion') }}</textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control" 
                               value="{{ old('slug') }}" placeholder="categoria-ejemplo">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="orden" id="orden" class="form-control" 
                               value="{{ old('orden', 0) }}" min="0" placeholder="0">
                        <small style="color: var(--text-secondary); font-size: 0.85rem; margin-top: 5px; display: block;">
                ...
                <div class="form-group">
                    ...
                    <div class="color-picker-wrapper">
                        <div class="color-preview" id="colorPreview" style="background-color: #D93690;"></div>
                        <input type="color" name="color" id="color" class="form-control color-input" 
                               value="{{ old('color', '#D93690') }}">
                    </div>
                    <small style="color: var(--text-secondary); font-size: 0.85rem; margin-top: 5px; display: block;">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="icono" id="icono" value="{{ old('icono', 'fas fa-book') }}">
                    <div class="icon-selector">
                        <div class="icon-option selected" data-icon="fas fa-book">
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_descripcion" id="meta_descripcion" class="form-control" 
                              placeholder="Descripción para motores de búsqueda (máximo 160 caracteres)">{{ old('meta_descripcion') }}</textarea>
                    <small style="color: var(--text-secondary); font-size: 0.85rem; margin-top: 5px; display: block;">
