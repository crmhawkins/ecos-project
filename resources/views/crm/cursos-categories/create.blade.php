...
@section('titulo', 'Crear Categoria de Cursos')
...
@section('content')
 <div class="page-heading card" style="box-shadow: none !important" >
    <div class="page-title card-body">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Crear categoria de cursos</h3>
                <p class="text-subtitle text-muted">Formulario para registrar una categoria de cursos</p>
            </div>
    ...
    <section class="section mt-4">
        <div class="card">
            <div class="card-body">
                <form action="{{route('cursosCategoria.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
