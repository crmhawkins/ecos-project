...
@section('content')
 <div class="page-heading card" style="box-shadow: none !important" >
    ...
    <section class="section mt-4">
        <div class="card">
            <div class="card-body">
                <form action="{{route('serviciosCategoria.update', $categoria->id)}}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('terms') is-invalid @enderror" id="terms" name="terms">{{ old('terms',$categoria->terms) }}</textarea>
                                    @error('terms')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="flex flex-row align-items-start mb-0">
                                        <select id="type" class="choices w-100 form-select  @error('type') is-invalid @enderror" name="type">
                                            ...
                                            <option {{ old('type',$categoria->type) == 1 ? 'selected' : '' }} value="1">Proveedor</option>
                                            <option {{ old('type',$categoria->type) == 2 ? 'selected' : '' }} value="2">Propio</option>
                                        </select>
                                    </div>
                                    @error('type')
                                    <span class="invalid-feedback" role="alert">
