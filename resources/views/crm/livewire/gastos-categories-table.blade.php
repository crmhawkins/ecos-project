        ...
        <div class="table-responsive">
             <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @foreach ( $categorias as $categoria )
                        <tr class="clickable-row" data-href="{{route('categorias-gastos.edit', $categoria->id)}}">
                            <td class="px-3" style="width: 60%">{{$categoria->nombre}}</td>
                            <td class="flex flex-row justify-evenly align-middle" style="min-width: 120px">
                                <a class="" href="{{route('categorias-gastos.edit', $categoria->id)}}"><img src="{{asset('assets/icons/edit.svg')}}" alt="Editar servicio"></a>
            ...
            @if( count($categorias) == 0 )
                <div class="text-center py-4">
                    <h3 class="text-center fs-3">No se encontraron registros de <strong>CATEGORIA DE Gastos</strong></h3>
...
@section('scripts')
    ...
    <script>
        ...
        function getDelete(id) {
            // Ruta de la peticion
            const url = '{{route("categorias-gastos.delete")}}'
            // Peticion
            return $.ajax({
                type: "POST",
                url: url,
