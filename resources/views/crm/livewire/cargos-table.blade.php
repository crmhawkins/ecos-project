        ...
        <div class="table-responsive">
             <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="clickable-row" data-href="{{route('cargo.edit', $cargo->id)}}">
                            <td>{{$cargo->name}}</td>
                            <td class="flex flex-row justify-evenly align-middle" style="min-width: 120px">
                                <a class="" href="{{route('cargo.edit', $cargo->id)}}"><img src="{{asset('assets/icons/edit.svg')}}" alt="Editar cargo"></a>
                                <a class="delete" data-id="{{$cargo->id}}" href=""><img src="{{asset('assets/icons/trash.svg')}}" alt="Eliminar cargo"></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
