        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div style="background:#fff;border-radius:12px;padding:40px;box-shadow:0 2px 20px rgba(0,0,0,0.06);">
                    ...
                    <h2 style="color:var(--primary-color,#D93690);margin-top:32px;margin-bottom:8px;">3. Propiedad intelectual e industrial</h2>
                    ...
                    <p>Queda expresamente prohibida la reproducción, distribución, comunicación pública o transformación de dichos contenidos sin la autorización previa y por escrito de Grupo ECOS.</p>

                    <h2 style="color:var(--primary-color,#D93690);margin-top:32px;margin-bottom:8px;">4. Condiciones de uso</h2>
                    ...
                    <p>Grupo ECOS no garantiza la inexistencia de interrupciones o errores en el acceso al Sitio Web o a sus contenidos, ni que este se encuentre siempre actualizado, aunque pondrá su mayor diligencia en evitarlos o subsanarlos.</p>
                    ...
                    <h2 style="color:var(--primary-color,#D93690);margin-top:32px;margin-bottom:8px;">6. Legislación aplicable y jurisdicción</h2>
                    <p>El presente Aviso Legal se rige por la legislación española. Para la resolución de cualquier controversia que pudiera derivarse del acceso o uso del Sitio Web, las partes se someten a los Juzgados y Tribunales competentes conforme a la normativa vigente.</p>
