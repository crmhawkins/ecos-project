...
Route::get('/checkout', function () {
    return view('webacademia.checkout');
});
...
Route::get('/event_single', function () {
    return view('webacademia.event_single');
});

Route::get('/event', function () {
    return view('webacademia.event');
});

Route::get('/faq', function () {
    return view('webacademia.faq');
});

Route::get('/index_2', function () {
    return view('webacademia.index_2');
});
...
Route::get('/single_shop', function () {
    return view('webacademia.single_shop');
});

Route::get('/team-details', function () {
    return view('webacademia.team-details');
});

Route::get('/team', function () {
    return view('webacademia.team');
});
