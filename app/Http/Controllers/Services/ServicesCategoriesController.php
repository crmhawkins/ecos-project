...
class ServicesCategoriesController extends Controller
{
    public function index()
    {
        ...
        return view('crm.services-categories.index', compact('servicios'));
    }

    public function create() {
        return view('crm.services-categories.create');
    }
    ...
    public function edit(string $id){
        ...
        return view('crm.services-categories.edit', compact('categoria'));
    }
