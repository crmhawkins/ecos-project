...
class InvoiceController extends Controller
{
    public function index()
    {
        ...
        return view('crm.invoices.index', compact('facturas'));
    }
    public function edit(string $id)
    {
        ...
        return view('crm.invoices.edit', compact( 'factura', 'invoiceStatuses', 'invoice_concepts'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('crm.invoices.show', compact('invoice','empresa','invoiceConcepts'));
    }
