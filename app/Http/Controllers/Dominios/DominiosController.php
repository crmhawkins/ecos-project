...
class DominiosController extends Controller
{
    public function index()
    {
        ...
        return view('crm.dominios.index', compact('dominios'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('crm.dominios.edit', compact('dominio','clientes','estados'));
    }
    public function create()
    {
        $clientes = Client::all();
        return view('crm.dominios.create', compact('clientes'));
    }
