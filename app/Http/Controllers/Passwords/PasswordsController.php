...
class PasswordsController extends Controller
{
    public function index()
    {
        ...
        return view('crm.passwords.index', compact('passwords'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('crm.passwords.edit', compact('password','clientes',));
    }
    public function create()
    {
        $clientes = Client::all();
        return view('crm.passwords.create', compact('clientes'));
    }
