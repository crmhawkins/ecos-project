...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.users.index', compact('usuarios'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.users.create', compact('role','departamentos', 'posiciones'));
    ...
    public function show(string $id)
    {
        ...
        return view('crm.users.show', compact('usuario'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $departamentos = UserDepartament::all();
        $posiciones = UserPosition::all();
        return view('crm.users.edit', compact('usuario', 'role', 'departamentos', 'posiciones'));
