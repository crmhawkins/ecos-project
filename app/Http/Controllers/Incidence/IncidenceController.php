...
class IncidenceController extends Controller
{
    public function index()
    {
        ...
        return view('crm.incidences.index', compact('incidences'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.incidences.create', compact('clientes', 'presupuestos', 'suppliers', 'users', 'estados'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('crm.incidences.edit', compact('incidencia', 'clientes', 'presupuestos', 'suppliers', 'users', 'estados'));
    }
