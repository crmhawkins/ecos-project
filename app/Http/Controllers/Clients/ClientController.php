...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.clients.index', compact('clientes'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.clients.create', compact('gestores','clientes','countries'));
    ...
    public function show(string $id)
    {
        ...
        return view('crm.clients.show', compact('cliente'));
    ...
    public function edit(string $id)
    {
        ...
        return view('crm.clients.edit', compact('clientes', 'cliente', 'gestores', 'contactos'));
    }
    ...
    public function createFromBudget()
    {
        $gestores = User::all();
        $clientes = Client::all();
        return view('crm.clients.createFromBudget', compact('gestores', 'clientes'));
    }
    public function createFromPetition()
    {
        $gestores = User::all();
        $clientes = Client::all();
        return view('crm.clients.createFromPetition', compact('gestores', 'clientes'));
    }
