...
class TasksController extends Controller
{
    ...
    {
        $tareas = Task::all();
        return view('crm.tasks.index', compact('tareas'));
    }
    public function cola()
    {
        $usuarios = User::where('access_level_id',5)->where('inactive', 0)->get();
        //$usuarios = User::all();
        return view('crm.tasks.cola', compact('usuarios'));
    }
    public function revision()
    {
        $tareas = Task::all();
        return view('crm.tasks.revision', compact('tareas'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('crm.tasks.edit', compact('task', 'prioritys', 'employees', 'data', 'status'));
    }
    ...
    public function calendar($id)
    {
        ...
        return view('crm.tasks.timeLine', [
            'user' => $user,
            'horas' => $horas,
            'horas_hoy' => $horas_hoy,
            'horas_dia' => $horas_dia,
