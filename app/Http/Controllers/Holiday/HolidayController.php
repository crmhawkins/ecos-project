...
class HolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.holidays.index', compact('holidays', 'userHolidaysQuantity', 'numberOfHolidayPetitions'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.holidays.create', compact('holidays', 'userHolidaysQuantity', 'numberOfHolidayPetitions'));
    }
    ...
    public function edit(HolidaysPetitions $holidayPetition)
    {
        ...
        return view('crm.admin.user_holidays.edit', compact('holidayPetition'));
    }
