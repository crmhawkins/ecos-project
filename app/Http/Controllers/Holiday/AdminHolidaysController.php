...
class AdminHolidaysController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.admin.admin_holidays.index', compact('holidays','usuario'));
    }
    ...
    public function addedRecord()
    {
        ...
        return view('crm.admin.admin_holidays.record', compact('holidaysAdditions'));
    }
    ...
    public function allHistory()
    {
        ...
        return view('crm.admin.admin_holidays.allhistory', compact('holidays','today'));
    }
    ...
    public function usersPetitions(){
        ...
        return view('crm.holidays.gestion',compact('numberOfholidaysPetitions','holydayEvents'));
    }
    ...
    public function managePetition(string $id)
    {
        ...
        $userId = Auth::id();
        $usuario = User::find($userId);
        return view('crm.holidays.managePetitions', compact('holidayPetition', 'usuario'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.admin.admin_holidays.create',  compact('adminUsers'));
    }
