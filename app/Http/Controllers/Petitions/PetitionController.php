...
class PetitionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.petitions.index', compact('petitions'));
    }
    public function indexUser()
    {
        $petitions = Petition::where('admin_user_id',Auth()->user()->id)->get();
        return view('crm.petitions.indexUser', compact('petitions'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.petitions.create', compact('gestores', 'clientes', 'clienteId','gestorId'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('crm.petitions.edit', compact('peticion',  'gestores', 'clientes'));
    }
