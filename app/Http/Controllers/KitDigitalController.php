...
class KitDigitalController extends Controller
{
    public function index(){
        ...
        return view('crm.kitDigital.indexWhatsapp', compact('kitDigitals'));
    ...
    public function listarClientes(){
        ...
        return view('crm.kitDigital.listarClientes');
    }
    ...
    public function create(){
        ...
        return view('crm.kitDigital.create', compact('usuario','clientes','servicios', 'estados', 'gestores','comerciales'));
    }
    ...
    public function storeComercial(Request $request){
     ...
     public function whatsapp($id)
     {
         ...
         return view('crm.whatsapp.whatsappIndividual', compact('resultado','cliente'));
     }
}
