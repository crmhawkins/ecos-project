...
class PortalClientesController extends Controller
{
    ...
    public function dashboard(Request $request){
        ...
        if ($cliente) {
            return view('crm.portal.dashboard', compact('cliente'));
        }
        return view('crm.portal.login');
    }
    ...
    public function tareasActivas(Request $request){
        $cliente = session('cliente');
        if ($cliente) {
            return view('crm.portal.tareasActivas',compact('cliente'));
        }
        return view('crm.portal.login');
    }
    ...
    public function pageTasksViewer(Request $request)
    {
        ...
        if ($cliente) {
            ...
            return view('crm.portal.tareasActivas',compact('ids', 'cliente', 'proyectos', 'tasksPro', 'ids','tiempoTotalFormato','tiempoGastadoFormato','tiempoRestanteFormato'));
        }
        return view('crm.portal.login');
    }
    ...
    public function changePin(Request $request){
        ...
        if ($cliente) {
            ...
            return view('crm.portal.pin',compact('cliente'));
        }
        return view('crm.portal.login');
    }
    ...
    public function setPin(Request $request)
    {
        ...
        return view('crm.portal.login')->with('toast', [
            'icon' => 'error',
    ...
    public function showBudget(Request $request, $id)
    {
        ...
        return view('crm.portal.presupuesto', compact('cliente', 'budget', 'concepts', 'empresa'));
    }
    public function showInvoice(Request $request,$id)
    {
        ...
        return view('crm.portal.factura', compact('cliente','invoice', 'invoiceConceptsFormated', 'data','empresa'));
    }
