...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.campania.index', compact('campanias'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.campania.create', compact('clientes', 'clienteId'));
    ...
    public function edit(string $id){
        ...
        return view('crm.campania.edit', compact('project', 'clientes'));
    ...
    public function createFromBudget(string $id)
    {
        ...
        return view('crm.campania.createFromBudget', compact('cliente', 'presupuesto'));
    }
    public function createFromBudgetAndPetition(string $id, string $petitionid)
    {
        $cliente = Client::find($id);

        return view('crm.campania.createFromBudget', compact('cliente','petitionid'));
    }
