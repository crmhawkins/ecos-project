...
class CrmActivityMeetingController extends Controller
{
    ...
    public function createClientMeeting(Client $client)
    {
        ...
        return view('crm.admin.crm_activities.createClientMeeting', compact('client', 'contactBy'));
    }
    ...
    public function viewMeeting($id){
        ...
        return view('crm.crm_activities.meeting.show', compact('meeting', 'contactBy', 'comments'));
    }
    ...
    public function createMeetingFromAllUsers(){
        ...
        return view('crm.crm_activities.meeting.create', compact('clients', 'usuarios', 'usuariosActa', 'contactBy'));
    }
    ...
    public function dividirAudioPorTamaño($filePath, $outputDirectory, $maxSizeMB = 25)
    {
        ...
        $bitrate = shell_exec("ffprobe -v error -select_streams a:0 -show_entries stream=bit_rate -of default=noprint_wrappers=1:nokey=1 " . escapeshellarg($filePath));
        ...
        $command = "ffmpeg -i " . escapeshellarg($filePath) . " -f segment -segment_time {$segmentDuration} -c:a libmp3lame -b:a 128k " . escapeshellarg($outputDirectory) . "/" . escapeshellarg($baseName) . "_part%d.mp3";
