...
class BudgetConceptsController extends Controller
{
    ...
    public function createTypeOwn(Budget $budget)
    {
        ...
        return view('crm.budgets-concepts.creteTypeOwn', compact('categorias', 'presupuesto'));
    }
    ...
    public function editTypeOwn(BudgetConcept $budgetConcept)
    {
        ...
        return view('crm.budgets-concepts.editTypeOwn', compact('budgetConcept', 'presupuesto', 'services', 'serviceCategories'));
    }
    ...
    public function createTypeSupplier(Budget $budget)
    {
        ...
        return view('crm.budgets-concepts.createTypeSupplier', compact(
            'categorias',
            'presupuesto',
    ...
    public function editTypeSupplier(string $id)
    {
        ...
        return view('crm.budgets-concepts.editTypeSupplier', compact('budgetConcept', 'presupuesto','suppliers', 'budgetSuppliersSaved', 'budgetSupplierSelectedOption', 'services', 'categorias', 'client', 'arrayEmails'));
    }
