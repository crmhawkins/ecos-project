...
class BudgetController extends Controller
{
    ...
    {
        $budgets = Budget::all();
        return view('crm.budgets.index', compact('budgets'));
    }
    public function indexUser()
    {
        $budgets = Budget::where('admin_user_id',auth()->user()->id)->get();
        return view('crm.budgets.indexUser', compact('budgets'));
    }
    ...
    public function statusProjects()
    {
        ...
        return view('crm.budgets.status', compact('clientes'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.budgets.create', compact('gestores','comerciales', 'clientes', 'campanias', 'formasPago', 'clienteId','gestorId', 'projectId'));
    }
    ...
    public function createFromPetition(string $id)
    {
        ...
        return view('crm.budgets.create', compact('gestores', 'clientes', 'campanias', 'formasPago',
    ...
    public function show(string $id)
    {
        ...
        return view('crm.budgets.show', compact('presupuesto','empresa','BudgetConcepts'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('crm.budgets.edit', compact('projectId','presupuesto', 'campanias', 'gestores', 'formasPago','estadoPresupuesto', 'budgetConcepts','thisBudgetStatus','clientes','porcentaje'));
    }
    ...
    {
        $id = $cliente->id;
        return view('crm.budgets.create', compact('id'));
    }
    ...
    public function getBudget($budget)
    {
        ...
        $filename = $budget . '.pdf';
        if ($budget_val) {
            return view('crm.clients.budgetview', compact('budget', 'budget_val', 'filename'));
        } else {
            return view('crm.clients.budgetnotfound');
        }
    }
