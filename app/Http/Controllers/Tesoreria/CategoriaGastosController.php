...
class CategoriaGastosController extends Controller
{
    public function index() {
        ...
        return view('crm.tesoreria.gastos-categories.index');
    }

    public function create(){
        return view('crm.tesoreria.gastos-categories.create');
    }
    ...
    public function edit(CategoriaGastos $categoria){
        ...
        return view('crm.tesoreria.gastos-categories.edit', compact('categoria'));
    }
