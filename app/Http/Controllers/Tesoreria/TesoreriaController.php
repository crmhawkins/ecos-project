...
class TesoreriaController extends Controller
{
    ...
    public function indexUnclassifiedExpensese(Request $request){
        return view('crm.tesoreria.gastos-sin-clasificar.index');
    }

    public function indexAssociatedExpenses(){
        return view('crm.tesoreria.gastos-asociados.index');
    }

    public function createIngresos(){
        $banks = BankAccounts::all();
        $invoices = Invoice::all();
        return view('crm.tesoreria.ingresos.create', compact('banks','invoices'));
    }
    ...
    public function createGastos(){
        ...
        return view('crm.tesoreria.gastos.create',compact( 'banks', 'paymentMethods','tiposIva','categorias'));
    }
    ...
    public function createAssociatedExpenses(){
        ...
        return view('crm.tesoreria.gastos-asociados.create',compact( 'banks', 'paymentMethods','purchaseOrders','tiposIva','categorias'));
    }
    ...
    public function editIngresos(string $id){
        ...
        return view('crm.tesoreria.ingresos.edit',compact('ingreso','banks','invoices'));
    }
    ...
    public function editGastos(string $id){
        ...
        return view('crm.tesoreria.gastos.edit', compact('gasto', 'banks', 'paymentMethods','tiposIva','categorias'));
    ...
    public function editUnclassifiedExpensese(string $id){
        ...
        return view('crm.tesoreria.gastos-sin-clasificar.edit', compact('unclassifiedExpense', 'banks', 'paymentMethods', 'budgets', 'purchaseOrders'));
    }
    ...
    public function editAssociatedExpenses(string $id){
        ...
        return view('crm.tesoreria.gastos-asociados.edit',compact('gasto', 'banks', 'paymentMethods', 'budgets', 'purchaseOrders','tiposIva','categorias'));
    }
