...
class CuadroController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.tesoreria.cuadro.index', compact('diasDelMes', 'nameMonth', 'banksAccounts', 'bigArray', 'month', 'arrayTotal', 'arrayTotalPrevisto', 'year', "day", 'globalArrayFactura', 'ingresos', 'gastos', 'gastosAsociados'));
    }
