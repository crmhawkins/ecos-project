...
class CategoriaAsociadosController extends Controller
{
    public function index() {
        ...
        return view('crm.tesoreria.gastos-asociados-categories.index');
    }

    public function create(){
        return view('crm.tesoreria.gastos-asociados-categories.create');
    }
    ...
    public function edit(CategoriaGastosAsociados $categoria){
        ...
        return view('crm.tesoreria.gastos-asociados-categories.edit', compact('categoria'));
    }
