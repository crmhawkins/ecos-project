...
class DiarioCajaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.contabilidad.diarioCaja.index', compact('response'));
    }
    ...
    public function createIngreso()
    {
        ...
        return view('crm.contabilidad.diarioCaja.create', compact('ingresos','grupos','response','numeroAsiento','estados'));
    }
    public function createGasto()
    {
        ...
        return view('crm.contabilidad.diarioCaja.createGasto', compact('gastos','grupos','response','numeroAsiento', 'formasPago', 'estados'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('crm.contabilidad.diarioCaja.edit', compact('fila','invoice','grupos','response'));
    ...
    public function mayorIndex()
    {
        ...
        return view('crm.contabilidad.mayor.index', compact('response','invoice','grupos','responses'));
    ...
    public function mayorShow($id)
    {
        ...
        // return view('crm.contabilidad.mayor.show', compact('response'));
