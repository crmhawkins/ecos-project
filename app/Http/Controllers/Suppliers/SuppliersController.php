...
class SuppliersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('crm.suppliers.index', compact('proveedores'));
    }
    ...
    public function create()
    {
        ...
        return view('crm.suppliers.create', compact('countries'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $countries = Country::all();
        return view('crm.suppliers.edit', compact('proveedor', 'countries'));
    }
